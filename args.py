...
def get_args():
    ...
    parser.add_argument('--vl_model', type=str, default=r'/content/drive/MyDrive/Vision_LanguageFinal/MeaCap/clip-vit-base-patch32')
    parser.add_argument("--parser_checkpoint", type=str, default=r'/content/drive/MyDrive/Vision_LanguageFinal/MeaCap/flan-t5-base-VG-factual-sg')
    parser.add_argument("--wte_model_path", type=str, default=r'/content/drive/MyDrive/Vision_LanguageFinal/MeaCap/all-MiniLM-L6-v2')
    parser.add_argument("--lm_model_path", type=str, default=r'/content/HuggingFace/ImageText/MeaCap-family/pretrain_model/CBART_COCO')
